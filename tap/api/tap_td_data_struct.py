...
TapAPIHisFundQryRsp = {
    ...
    "PreEquity": "double",
    "PreAvailable1": "double",
    "PreAvailable2": "double",
    "PreMarketEquity": "double",
    "FutureMatchQty": "unsigned int",
    "OptionMatchQty": "unsigned int",
    "FuturePositionQty": "unsigned int",
    "OptionPositionQty": "unsigned int",
    "FutureTurnover": "double",
    "CashInValue": "double",
    "CashOutValue": "double",
    "AdjustValue": "double",
    "CashPledged": "double",
